 ...
 */
public final class RequestLogger extends ExtendedLoggerWrapper {
    private static final long serialVersionUID = 11711440321158L;
    private final ExtendedLoggerWrapper logger;

    private static final String FQCN = RequestLogger.class.getName();
    private static final Level OFF = Level.forName("OFF", Level.OFF.intLevel());
    private static final Level FATAL = Level.forName("FATAL", Level.FATAL.intLevel());
    private static final Level ERROR = Level.forName("ERROR", Level.ERROR.intLevel());
    private static final Level WARN = Level.forName("WARN", Level.WARN.intLevel());
    private static final Level INFO = Level.forName("INFO", Level.INFO.intLevel());
    private static final Level DEBUG = Level.forName("DEBUG", Level.DEBUG.intLevel());
    private static final Level TRACE = Level.forName("TRACE", Level.TRACE.intLevel());
    private static final Level ALL = Level.forName("ALL", Level.ALL.intLevel());

    private RequestLogger(final Logger logger) {
    ...
    public static RequestLogger create() {
        ...
        return new RequestLogger(wrapped);
    }
     ...
     */
    public static RequestLogger create(final Class<?> loggerName) {
     ...
     * @return The custom Logger.
     */
    public static RequestLogger create(final Class<?> loggerName, final MessageFactory messageFactory) {
     ...
     * @return The custom Logger.
     */
    public static RequestLogger create(final Object value) {
     ...
     * @return The custom Logger.
     */
    public static RequestLogger create(final Object value, final MessageFactory messageFactory) {
     ...
     * @return The custom Logger.
     */
    public static RequestLogger create(final String name) {
     ...
     * @return The custom Logger.
     */
    public static RequestLogger create(final String name, final MessageFactory messageFactory) {
